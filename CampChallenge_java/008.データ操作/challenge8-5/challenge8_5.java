 ...
 * @author mat
 */
@WebServlet(name = "challenge8_5", urlPatterns = {"/challenge8_5"})
public class challenge8_5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet challenge8_5</title>");            
            out.println("</head>");
            out.println("<body>");
            //セッション作成
            HttpSession hs = request.getSession(true);

            //受け取るパラメータの文字コード（jspのもの）
