 ...
 * @author mat
 */
@WebServlet(name = "challenge10_12", urlPatterns = {"/challenge10_12"})
public class challenge10_12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //データの受取
        String name = request.getParameter("txtSearthName");
        String ageStr = request.getParameter("txtSearthAge");
        String birthYearStr = request.getParameter("txtSearthBirthYear");
        String birthMonthStr = request.getParameter("txtSearthBirthMonth");
        String birthDayStr = request.getParameter("txtSearthBirthDay");
