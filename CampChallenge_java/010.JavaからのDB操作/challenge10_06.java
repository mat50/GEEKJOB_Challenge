 ...
 * @author mat
 */
@WebServlet(name = "challenge10_06", urlPatterns = {"/challenge10_06"})
public class challenge10_06 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //課題「テーブルへ情報を格納」でINSERTしたレコード（profilesID=5）を指定して削除する
