 ...
 * @author mat
 */
@WebServlet(name = "challenge10_07", urlPatterns = {"/challenge10_07"})
public class challenge10_07 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //profileID=1のnameを「松岡 修造」に、ageを48に、birthdayを1967-11-06に更新する
            db_st = db_con.prepareStatement("update profiles set name='松岡修造',age=48,birthday='1967-11-06' where profilesID=2");
