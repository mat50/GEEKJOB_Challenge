...
/**
 * 以下の課題を、JavaからのJDBCを用いて実現してください。 フォームからデータを挿入できる処理を構築してください。
 *
 * @author mat
 */
@WebServlet(name = "challenge10_09", urlPatterns = {"/challenge10_09"})
public class challenge10_09 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //データの受取
        String IDStr = request.getParameter("txtInsertID");
        String name = request.getParameter("txtInsertName");
        String tell = request.getParameter("txtInsertTell");
        String ageStr = request.getParameter("txtInsertAge");
        String birthYearStr = request.getParameter("txtInsertBirthYear");
        String birthMonthStr = request.getParameter("txtInsertBirthMonth");
        String birthDayStr = request.getParameter("txtInsertBirthDay");
...
//            }
            ...
            db_st.setInt(4, age);
            db_st.setDate(5, new Date(birthdate.getTime()));
            //データベースの操作を許可する
            db_st.executeUpdate();
