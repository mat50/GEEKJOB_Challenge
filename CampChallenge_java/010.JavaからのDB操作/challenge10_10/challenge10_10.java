 ...
 * @author mat
 */
@WebServlet(name = "challenge10_10", urlPatterns = {"/challenge10_10"})
public class challenge10_10 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //データの受取
        String deletionStr = request.getParameter("txtDeletion");
        ...
        try {
            ...
            //文字列型を数値型に変換
            int deletion = Integer.parseInt(deletionStr);
