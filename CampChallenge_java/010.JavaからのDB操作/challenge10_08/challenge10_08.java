...
/**
 * 以下の課題を、JavaからのJDBCを用いて実現してください。 検索用のフォームを用意し、名前の部分一致で検索＆表示する処理を構築してください。
 *
 * @author mat
 */
@WebServlet(name = "challenge10_08", urlPatterns = {"/challenge10_08"})
public class challenge10_08 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //jspから受け取った文字列でnameを検索する
            db_st = db_con.prepareStatement("select * from profiles where name like ?");
            //''で囲むと%が機能しないので、ここで%を入れる
